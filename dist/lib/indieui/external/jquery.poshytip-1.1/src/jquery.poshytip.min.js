...
(function($) {
    ...
    function loadStylesheet() {
        ...
        var scriptName = "jquery.poshytip";
        var cssName = "tip-yellow/tip-yellow.css";
        ...
        for (var i = scriptElements.length; i > 0; i--) {
            ...
            if (obj.src.indexOf(scriptName) > -1) {                
                path = obj.src.substring(0, obj.src.lastIndexOf("/") + 1);
                break;
            }
        }
        ...
        if (path == '') {
            if (typeof console != "undefined" && typeof console.debug != "undefined") {
                console.log('Poshy Tip jQuery plugin 插件加载异常');
            } else {
                alert('Poshy Tip jQuery plugin 插件加载异常');
            }
        }
