        ...
        this.each(function () {
            ...
            $inputTxt.each(function () {
                ...
                if ($(this).attr("disabled")) {
                    ...
                    var queryFormat = $(this).attr("queryFormat");
                    if (typeof (queryFormat) != 'undefined' && queryFormat != undefined) {
                        $(this).addClass("FormatInputQueryTxt");

                        var _w = $(this).width();
                        var _h = $(this).outerHeight(false);
                        ...
                        var value = $(this).val();
                        var id = "formatInputQuery" + $(this).attr("id");

                        var btnHtml = "<span id='" + id + "' class='FormatInputQueryBtn' title='点击查询'>&nbsp;</span>";
            ...
            $inputButton.each(function () {
                ...
                if (typeof ($(this).attr("mian")) != 'undefined') {
                    $(this).addClass("Main");
                }
            });
