...
public class RuleEdit extends SpringlineCommand {

	/**
	 * 
	 */
	private static final long serialVersionUID = -9167046750872614555L;
	private String id;
    private Integer counterFee;
    private Double dayCap;
    private Integer areaNumber;
    private String regionPriority;
    private String activationConditionOne;
